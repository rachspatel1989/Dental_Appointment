...
<!--[if gt IE 9]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <style type="text/css">
            .loader {
                ...
                z-index: 999999;
                /*opacity: 0.9;*/                    
                background: url('slot_loader.gif') 50% 50% no-repeat #fff;
                overflow-x: hidden;
            }
        </style>
    </head>
    ...
    <body class=" sidebar_main_open sidebar_main_swipe">
        ...
        <div id="page_content">
            <?php
            $case_id = $_GET['r_id'];
            $patient_sql = mysql_query("SELECT *
FROM
case_master
INNER JOIN advice_master ON case_master.case_id = advice_master.case_id
INNER JOIN addional_info_master ON advice_master.case_id = addional_info_master.case_id
INNER JOIN appointment_master ON addional_info_master.case_id = appointment_master.pat_id
INNER JOIN cbct_teeth_master ON appointment_master.pat_id = cbct_teeth_master.case_id
INNER JOIN diagnostic_master ON cbct_teeth_master.case_id = diagnostic_master.case_id
INNER JOIN service_master ON diagnostic_master.case_id = service_master.case_id
WHERE case_master.case_id= '$case_id' GROUP BY case_master.case_id");
            ...
            <div id="page_content_inner">
                <form action="" method="post" class="uk-form-stacked" id="product_edit_form" enctype="multipart/form-data">
                    <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                        ...
                        <?php
                        $oral_radiology = $patient_row['oral_radiology'];
                        $oral_pathology = $patient_row['oral_pathology'];
                        $tob_cess_prgm = $patient_row['tob_cess_prgm'];
                        ?>                        
                                    ...
                                    <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                        <div class="uk-width-large-1-1">
                                            <span class="icheck-inline">
                                                <?php
                                                if ($oral_radiology == 'Yes') {
                                                    ?>
                                                    <input id="oralradiology" type="checkbox" name="oralradiology" value="Yes" checked disabled data-md-icheck/>
                                                    <?php
                                                } else {
                                                    ?>
                                            ...
                                            <span class="icheck-inline">
<?php
if ($oral_pathology == 'Yes') {
    ?>
                                                    <input type="checkbox" id="oralpathology" name="oralpathology" value="Yes" checked disabled data-md-icheck />
                                                    <?php
                                                } else {
                                                    ?>
                                            ...
                                            <span class="icheck-inline">
                                                <?php
                                                if ($tob_cess_prgm == 'Yes') {
                                                    ?>
                                                    <input type="checkbox" id="tobaccoprogram" name="tobaccoprogram" checked disabled value="Yes" data-md-icheck />
                                                    <?php
                                                } else {
                                                    ?>
...
<?php
$sectional = $patient_row['sectional'];
$maxilla = $patient_row['maxilla'];
$mandible = $patient_row['mandible'];
$both_jaws = $patient_row['both_jaws'];
$tmj = $patient_row['tmj'];
$sinus_view = $patient_row['sinus_view'];
$middle_view = $patient_row['middle_view'];
$airway = $patient_row['airway'];
$implant = $patient_row['implant'];
$pathology = $patient_row['pathology'];
$root_canal = $patient_row['root_canal'];
$bone_loss = $patient_row['bone_loss'];
$impacted = $patient_row['impacted'];
$third_molar = $patient_row['third_molar'];
$opg = $patient_row['opg'];
$lat_cepal = $patient_row['lat_cepal'];
$pa_mandible = $patient_row['pa_mandible'];
$subment_view = $patient_row['subment_view'];
$tmj_view = $patient_row['tmj_view'];
$water_view = $patient_row['water_view'];
$hand_wrist = $patient_row['hand_wrist'];
$town_view = $patient_row['town_view'];
?>                            
                            <?php
                            if ($oral_radiology == 'Yes') {
                                ?>   
    ...
    if ($sectional == 'Yes') {
        ?>
                                                            <input type="checkbox" id="sectional" name="sectional" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($maxilla == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="maxilla" name="maxilla" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($mandible == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="mandible" name="mandible" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
    ...
    ?>                                                                                                        
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($both_jaws == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="both_jaws" name="both_jaws" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($sinus_view == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="sinus_view" name="sinus_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($tmj == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="tmj" name="tmj" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>                                                    
    ...
    if ($middle_view == 'Yes') {
        ?>                                                    
                                                            <input type="checkbox" id="middle_view" name="middle_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($airway == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="airway" name="airway" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                ...
                                                <div class="uk-width-large-1-3">
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($opg == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="opg" name="opg" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($lat_cepal == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="lat_cepal" name="lat_cepal" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($pa_mandible == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="pa_mandible" name="pa_mandible" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
    ...
    ?>                                                                                                         
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($subment_view == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="subment_view" name="subment_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($tmj_view == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="tmj_view" name="tmj_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($water_view == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="water_view" name="water_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
    ...
    if ($hand_wrist == 'Yes') {
        ?>
                                                            <input type="checkbox" id="hand_wrist" name="hand_wrist" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($town_view == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="town_view" name="town_view" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                ...
                                                <div class="uk-width-large-1-3">
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($implant == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="implant" name="implant" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($pathology == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="pathology" name="pathology" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($root_canal == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="root_canal" name="root_canal" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
    ...
    ?>                                                                                                         
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($bone_loss == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="bone_loss" name="bone_loss" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($impacted == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="impacted" name="impacted" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
                                                    ...
                                                    <span class="icheck-inline">
                                                        ...
                                                        if ($third_molar == 'Yes') {
                                                            ?>
                                                            <input type="checkbox" id="third_molar" name="third_molar" value="Yes" checked disabled data-md-icheck />
                                                            <?php
                                                        } else {
                                                            ?>
    ...
    <?php
    $prosthetic1 = $patient_row['prosthetic1'];
    $prosthetic2 = $patient_row['prosthetic2'];
    $prosthetic3 = $patient_row['prosthetic3'];
    $Operatice1 = $patient_row['Operatice1'];
    $Operatice2 = $patient_row['Operatice2'];
    $Operatice3 = $patient_row['Operatice3'];
    $Periodontia1 = $patient_row['Periodontia1'];
    $Periodontia2 = $patient_row['Periodontia2'];
    $oral_surgery1 = $patient_row['oral_surgery1'];
    $oral_surgery2 = $patient_row['oral_surgery2'];
    $cosmetic1 = $patient_row['cosmetic1'];
    $radiology1 = $patient_row['radiology1'];
    $radiology2 = $patient_row['radiology2'];
    ?>                                            
                                                <div class="uk-width-large-1-1">
                                                                    ...
                                                                    <td> <h3> Prosthetic: </h3>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $prosthetic1; ?>" name="prosthetic1" id="implate" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $prosthetic2; ?>" name="prosthetic2" id="bridge" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $prosthetic3; ?>" name="prosthetic3" id="cd_pd" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td> <h3> Operative: </h3>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $Operatice1; ?>" name="operative1" id="filling" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $Operatice2; ?>" name="operative2" id="endodontic" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $Operatice3; ?>" name="operative3" id="crown" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td> <h3> Periodontia: </h3>
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $periodontia1; ?>" name="periodontia1" id="scaling" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $periodontia2; ?>" name="periodontia2" id="surgical" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td> <h3> Oral Surgery: </h3>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $oral_surgery1; ?>" name="oral_surgery1" id="extraction" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $oral_surgery2; ?>" name="oral_surgery2" id="other_surgical" class="md-input" />
                                                                            </div>
                                                                        </div>    
                                                                    ...
                                                                    <td> <h3> Cosmetic: </h3>
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $cosmetic1; ?>" name="cosmetic1" id="teeth_whitening" class="md-input" />
                                                                            </div>
                                                                        </div> 
                                                                        <div class="uk-width-medium-1-3" style="height: 60px;">  
                                                                    ...
                                                                    <td> <h3> Radiology: </h3>
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text" readonly="" value="<?php echo $radiology1; ?>" name="radiology1" id="intra_oral" class="md-input" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="uk-width-medium-1-3">
                                                                            <div class="parsley-row">
                                                                                ...
                                                                                <input type="text"  readonly="" value="<?php echo $radiology2; ?>" name="radiology2" id="extra_oral" class="md-input" />
                                                                            </div>
                                                                        </div>
    <?php /* i. Intra Oral <br/>
      ii. Extra Oral */ ?>
      ...
      ii. Extra Oral */ ?>
                                                    ...
                                                    <div class="uk-width-large-1-1">
                                                        <div class="uk-form-row">
                                                            ...
                                                            <textarea class="md-input" name="notes" id="notes" cols="5" value="<?php echo $patient_row['notes']; ?>" rows="2"><?php echo $patient_row['notes']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
?>                            
<?php
$excisional = $patient_row['excisional'];
$incisional = $patient_row['incisional'];
$smear_aspir = $patient_row['smear_aspir'];
$immuno_fluor = $patient_row['immuno_fluor'];
$indicate_img1 = $patient_row['indicate_img1'];
$indicate_img2 = $patient_row['indicate_img2'];
$indicate_img3 = $patient_row['indicate_img3'];
$buccal_muco = $patient_row['buccal_muco'];
$gingiva = $patient_row['gingiva'];
$palate_hard = $patient_row['palate_hard'];
$teeth = $patient_row['teeth'];
$tongue = $patient_row['tongue'];
$tonsil = $patient_row['tonsil'];
$uvula = $patient_row['uvula'];
$palate_soft = $patient_row['palate_soft'];
$left_side = $patient_row['left_side'];
$right_side = $patient_row['right_side'];
$upper_side = $patient_row['upper_side'];
$lower_side = $patient_row['lower_side'];
?>        
<?php
if ($oral_pathology == 'Yes') {
    ?>                            
    ...
    if ($excisional == 'Yes') {
        ?>
                                                        <input type="checkbox" id="excisional" name="excisional" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
    ...
    ?>                                                
                                ...
                                if ($incisional == 'Yes') {
                                    ?>
                                                        <input type="checkbox" id="incisional" name="incisional" value="Yes" checked disabled data-md-icheck />
                                    <?php
                                } else {
                                    ?>
                                ...
                                if ($smear_aspir == 'Yes') {
                                    ?>
                                                        <input type="checkbox" id="smear_aspir" name="smear_aspir" value="Yes" checked disabled data-md-icheck />
                                    <?php
                                } else {
                                    ?>
    ...
    if ($immuno_fluor == 'Yes') {
        ?>
                                                        <input type="checkbox" id="immuno_fluor" name="immuno_fluor" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
                                                    ...
                                                    <div>
                                                        <div class="md-card md-card-hover">
                                                            <div class="gallery_grid_item md-card-content">
                                                                <span class="req">
                                                    <?php
                                                    if ($indicate_img1 == 'Yes') {
                                                        ?>
                                                                        <input type="checkbox" id="img1" name="img1" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                                        <input type="checkbox" id="img1" name="img1" value="Yes" data-md-icheck />
                                                        <?php
                                                    }
                                                    ?>                                                                                                                                
                                                                </span>
                                                    ...
                                                    <div>
                                                        <div class="md-card md-card-hover">
                                                            <div class="gallery_grid_item md-card-content">
                                                                <span class="req">
                                                    <?php
                                                    if ($indicate_img2 == 'Yes') {
                                                        ?>
                                                                        <input type="checkbox" id="img2" name="img2" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                                        <input type="checkbox" id="img2" name="img2" value="Yes" data-md-icheck />
                                                        <?php
                                                    }
                                                    ?>                                                                                                                                
                                                                </span>
                                                    ...
                                                    <div>
                                                        <div class="md-card md-card-hover">
                                                            <div class="gallery_grid_item md-card-content">
                                                                <span class="req">
                                                    <?php
                                                    if ($indicate_img3 == 'Yes') {
                                                        ?>
                                                                        <input type="checkbox" id="img3" name="img3" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                                        <input type="checkbox" id="img3" name="img3" value="Yes" data-md-icheck />
        <?php
    }
    ?>                                                                                                                                
                                                                </span>
                                            ...
                                            <div class="uk-width-large-1-1">
                                                ...
                                                <span class="icheck-inline">
                                                                    ...
                                                                    if ($gingiva == 'Yes') {
                                                                        ?>
                                                        <input type="checkbox" id="gingiva" name="gingiva" value="Yes" checked disabled data-md-icheck />
                                                                        <?php
                                                                    } else {
                                                                        ?>                                                    
    ...
    if ($palate_hard == 'Yes') {
        ?>
                                                        <input type="checkbox" id="palate_hard" name="palate_hard" value="Yes" checked disabled data-md-icheck />
                                                                        <?php
                                                                    } else {
                                                                        ?>
    ...
    if ($teeth == 'Yes') {
        ?>
                                                        <input type="checkbox" id="teeth" name="teeth" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
    ...
    ?>                                                
                                                ...
                                                <span class="icheck-inline">
                                                                    ...
                                                                    if ($tongue == 'Yes') {
                                                                        ?>
                                                        <input type="checkbox" id="tongue" name="tongue" value="Yes" checked disabled data-md-icheck />
                                                                        <?php
                                                                    } else {
                                                                        ?>
    ...
    if ($tonsil == 'Yes') {
        ?>
                                                        <input type="checkbox" id="tonsil" name="tonsil" value="Yes" checked disabled data-md-icheck />
        <?php
    } else {
        ?>
                                                ...
                                                <span class="icheck-inline">
                                                    ...
                                                    if ($buccal_muco == 'Yes') {
                                                        ?>
                                                        <input type="checkbox" id="buccal_muco" name="buccal_muco" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                ...
                                                <span class="icheck-inline">
                                                    ...
                                                    if ($palate_soft == 'Yes') {
                                                        ?>
                                                        <input type="checkbox" id="palate_soft" name="palate_soft" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
    ...
    ?>                                                                                                
                                                ...
                                                <span class="icheck-inline">
                                                    ...
                                                    if ($uvula == 'Yes') {
                                                        ?>
                                                        <input type="checkbox" id="uvula" name="uvula" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                ...
                                                <span class="icheck-inline">
                                                    ...
                                                    if ($left_side == 'Yes') {
                                                        ?>
                                                        <input type="checkbox" id="left" name="left" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
                                                ...
                                                <span class="icheck-inline">
                                                    ...
                                                    if ($right_side == 'Yes') {
                                                        ?>
                                                        <input type="checkbox" id="right" name="right" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
    ...
    if ($upper_side == 'Yes') {
        ?>
                                                        <input type="checkbox" id="upper" name="upper" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
    ...
    if ($lower_side == 'Yes') {
        ?>
                                                        <input type="checkbox" id="lower" name="lower" value="Yes" checked disabled data-md-icheck />
                                                        <?php
                                                    } else {
                                                        ?>
