...
<!--[if gt IE 9]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body class=" sidebar_main_open sidebar_main_swipe">
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-large-1-4 uk-width-medium-1-1">
                                    <div class="uk-input-group">
                                        <span for="uk_dp_start">Start Date</span>
                                ...
                                <div class="uk-width-large-1-4 uk-width-medium-1-1">
                                    <div class="uk-input-group">
                                        <span for="uk_dp_end">End Date</span>
                                        <span class="uk-input-group-addon"><i class="uk-input-group-icon uk-icon-calendar"></i></span>

                                        <input class="md-input" type="text" id="uk_dp_end">
                                    </div>
                                </div>
                                <div class="uk-width-large-1-4 uk-width-medium-1-1"></div>
                                <?php
                                $patient_sql = mysql_query("SELECT * FROM case_master INNER JOIN appointment_master ON case_master.case_id = appointment_master.pat_id where appointment_master.app_date >= CURDATE()  and appointment_master.status=0");
                                $rows_count = mysql_num_rows($patient_sql);
                                ?>
                                <div class="uk-width-large-1-4 uk-width-medium-1-1" id="app_hide_total">
                                    <div class="uk-input-group"></div>
                                    <h3>Total Appointments : <?php echo $rows_count; ?></h3> 
                                </div>                               
                            </div>
                        </div>
                        <div class="md-card-content">
                                        ...
                                        while ($patient_row = mysql_fetch_array($patient_sql)) {
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="uk-text-center">
                                                    <a href="casefile.php?r_id=<?php echo $case_id ?>" data-uk-tooltip="{pos:'bottom'}" title="View Case File" class="md-btn"><i class="uk-input-group-icon uk-icon-clock-o"> &nbsp;&nbsp;View Case File</i></a>
        ...
        <script>
            ...
            $('#uk_dp_end').change(function ()
            {
                var start_id = $('#uk_dp_start').val();
                var end_id = $('#uk_dp_end').val();

                var dataString = 'start_id=' + start_id + '&end_id=' + end_id;
                $.ajax({
                    type: "POST",
                    url: "caselist_viewcase.php",
                    data: dataString,
