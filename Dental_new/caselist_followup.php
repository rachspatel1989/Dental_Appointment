                                    ...
                                    <tbody>  
                                        ...
                                        while ($patient_row = mysql_fetch_array($patient_sql)) {
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="uk-text-center"><a href="casefile_followup.php?r_id=<?php echo $case_id ?>" data-uk-tooltip="{pos:'bottom'}" title="View Case"><i class="material-icons md-24">&#xE8F4;</i></a>
